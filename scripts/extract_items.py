...
MIN_AREA = 7e4  # Minimum area for bounding boxes to be considered valid

# TODO: create a higher resolution for backdrops

OUTPUT_FOLDER = "output_imgs"

CATEGORIES = ["characters", "decorations", "backdrops"]
...
def process_bboxes(
    ...
    output_path = f"output_imgs/{prefix + "-" if prefix else ""}{output_img_idx}.png"
...
if __name__ == "__main__":
    ...
    prefix = category_choice
    extract_items()
    print(f"Extracted {output_img_idx} items to {OUTPUT_FOLDER}")
    print(
        """\b
===========================  IMPORTANT  ===========================
Please review the output images before uploading them to the server.
          """
    )
